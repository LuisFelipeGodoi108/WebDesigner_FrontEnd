        ...
        <div class="cadastro_box">
            ...
            <div class="cadastro_box1">
                ...
                <form action="" method="" class="form1">
                    ...
                    <div class="box_form">
                        <div class="box_form_nasc">
                            ...
                            onkeyup="mascaraData(this.id);" />
                        </div>
                        <div class="box_form_cpf">
                            <b>CPF *</b>
                            <input type="text" name="login" placeholder="000.000.000-00" maxlenght="14" class="inp_cad3" id="pf_cpf"
                            onkeyup="mascaraCpf(this.id);" />
                        </div>
                    </div>
                    ...
                    <div class="box_form">
                        <div class="box_form_ddd1">
                            <b>DDD *</b>
                            <input type="text" name="ddd1" placeholder="(00)" maxlenght="4" class="inp_cad4" id="pf_dd1"
                            onkeyup="mascaraDdd(this.id);"/>
                        </div>
                        <div class="box_form_celular">
                            <b>Celular *</b>
                            <input type="text" name="celular" placeholder="00000 - 0000" maxlenght="10" class="inp_cad5" id="pf_cel" 
                            onkeyup="mascaraCel(this.id);"/>
                        </div>
                        <div class="box_form_ddd2">
                            <b>DDD *</b>
                            <input type="text" name="ddd2" placeholder="(00)" maxlenght="4" class="inp_cad4" id="pf_dd2"
                            onkeyup="mascaraDdd2(this.id);"/>
                        </div>
                        <div class="box_form_tel">
                            <b>Telefone *</b>
                            <input type="text" name="tel" placeholder="0000 - 0000" maxlenght="8" class="inp_cad5" id="pf_tel" 
                            onkeyup="mascaraTel(this.id);"/>
                        </div>
                    </div>
                ...
                <form action="" method="" class="form1_1">
                    ...
                    <div class="box_form">
                        <b>CNPJ *</b>
                        <input type="text" name="cnpj" placeholder="00.000.000/0000-00" maxlenght="18" class="inp_cad1" id="pj_cnpj"
                        onkeyup="mascaraCnpj(this.id);"/>
                    </div>
                    ...
                    <div class="box_form">
                        <div class="box_form_ddd1">
                            <b>DDD *</b>
                            <input type="text" name="ddd1_1" placeholder="(00)" maxlenght="4" class="inp_cad4" id="pj_dd1" 
                            onkeyup="mascaraDdd(this.id);"/>
                        </div>
                        <div class="box_form_celular">
                            <b>Celular *</b>
                            <input type="text" name="celular1" placeholder="00000 - 0000" maxlenght="10" class="inp_cad5" id="pj_cel"
                            onkeyup="mascaraCelular(this.id);"/>
                        </div>
                        <div class="box_form_ddd2">
                            <b>DDD *</b>
                            <input type="text" name="ddd2_1" placeholder="(00)" maxlenght="4"class="inp_cad4" id="pj_dd2"
                            onkeyup="mascaraDdd2(this.id);"/> 
                        </div>
                        <div class="box_form_tel">
                            <b>Telefone *</b>
                            <input type="text" name="tel1" placeholder="0000 - 0000" maxlenght="9" class="inp_cad5" id="pj_tel" 
                            onkeyup="mascaraTelefone(this.id);"/>
                        </div>
                    </div>
